...
const defaultHomepage = {
	...
	testimonials: [
		{ quote: 'Had a clear view of what lenders would ask before I applied. That alone saved me from firing off applications that would have gone nowhere.', author: 'Sarah M.', role: 'Wholesale distributor, VIC' },
		{ quote: 'Most comparison sites just list rates. This one asks what the money is for and whether you actually have the documents. That is the conversation lenders are having anyway.', author: 'James T.', role: 'Manufacturing, NSW' },
		{ quote: 'Knocked back by the bank, had no idea why. The guide on what to check after a decline was more useful than three phone calls to the lender.', author: 'Priya K.', role: 'Hospitality, QLD' },
		{ quote: 'Applied for equipment finance knowing what documents to have ready. The whole thing took days instead of weeks.', author: 'Michael R.', role: 'Transport, WA' },
	],
...
export default defineType({
	...
	fields: [
		...
		defineField({ name: 'testimonials', type: 'array', group: 'sections', of: [defineArrayMember({ type: 'object', fields: [defineField({ name: 'quote', type: 'text', rows: 3 }), defineField({ name: 'author', type: 'string' }), defineField({ name: 'role', type: 'string', description: 'e.g. Manufacturing, NSW' })], preview: { select: { title: 'author', subtitle: 'quote' } } })] }),
