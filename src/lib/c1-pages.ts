...
const c1_business_loans: C1PageData = {
  ...
  sections: [
    ...
    { heading: "When a business loan may not be the right fit", body: "Borrowing is not always the right answer.\n\nA business loan may be risky if:\n\nComparison One copy should never make debt feel casual. Good funding supports a move. Bad funding can turn a temporary gap into a heavier problem.", bullets: ["there is no clear repayment path;", "the funding is only covering ongoing losses;", "the loan has no specific business purpose;", "repayments depend on unrealistic future revenue;", "tax, legal or insolvency issues need professional advice first;", "the owner is using debt to avoid making a hard business decision;", "the funding product is mismatched to the use of funds."] },
  ...
  faqs: [
    ...
    { question: "Is Comparison One financial advice?", answer: "No. Comparison One provides general information and comparison pathways only. It does not provide financial, legal, tax or credit advice. - business.gov.au: Apply for a business loan.\n- business.gov.au: Choose your funding.\n- RBA: Small Business Economic and Financial Conditions, October 2025.\n- ABA: 2025 Banking Code of Practice.\n- AFIA: Online Small Business Lenders Code.\n- ASIC: Unfair contract term protections for small businesses. ---" },
...
const c1_working_capital: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Apply for a business loan.", "business.gov.au: Choose your funding.", "RBA: Small Business Economic and Financial Conditions, October 2025.", "AFIA: Online Small Business Lenders Code."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "What is the main risk?", answer: "The main risk is taking funding that solves this week\u2019s gap but creates heavier repayment pressure later. - business.gov.au: Apply for a business loan.\n- business.gov.au: Choose your funding.\n- RBA: Small Business Economic and Financial Conditions, October 2025.\n- AFIA: Online Small Business Lenders Code. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
...
const c1_invoice_finance: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["CommBank: What is invoice financing and how does it work?", "ScotPac: Invoice Finance Australia and invoice factoring/discounting explanations.", "business.gov.au: Apply for a business loan.", "ASIC: Unfair contract term protections for small businesses."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "Is invoice finance cheaper than an unsecured loan?", answer: "Not always. The cost depends on fees, advance rates, debtor quality, contract terms and usage. Compare the total cost and suitability. - CommBank: What is invoice financing and how does it work?\n- ScotPac: Invoice Finance Australia and invoice factoring/discounting explanations.\n- business.gov.au: Apply for a business loan.\n- ASIC: Unfair contract term protections for small businesses. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
  ],
  relatedLinks: [
...
const c1_equipment_finance: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Leasing or buying vehicles and equipment.", "business.gov.au: Apply for a business loan.", "Westpac/NAB/CommBank/ANZ public asset finance pages for product-language checks.", "ASIC: Unfair contract term protections."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "Can I use an unsecured loan instead?", answer: "Possibly. An unsecured loan may suit some equipment purchases, especially if the funding also covers installation, working capital or non-asset costs. Compare total cost and repayment pressure. - business.gov.au: Leasing or buying vehicles and equipment.\n- business.gov.au: Apply for a business loan.\n- Westpac/NAB/CommBank/ANZ public asset finance pages for product-language checks.\n- ASIC: Unfair contract term protections. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
  ],
  relatedLinks: [
...
const c1_unsecured_business_loans: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Apply for a business loan.", "AFIA: Online Small Business Lenders Code and SMART Box pricing disclosure.", "ASIC: Unfair contract term protections for small businesses.", "ABA: Banking Code of Practice."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "What is the biggest risk?", answer: "The biggest risk is accepting fast funding with repayments that strain cash flow. - business.gov.au: Apply for a business loan.\n- AFIA: Online Small Business Lenders Code and SMART Box pricing disclosure.\n- ASIC: Unfair contract term protections for small businesses.\n- ABA: Banking Code of Practice. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
  ],
  relatedLinks: [
...
const c1_knocked_back_by_bank: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Apply for a business loan.", "ABA: 2025 Banking Code of Practice.", "ASIC: Unfair contract term protections.", "AFCA: Appropriate lending to small business approach.", "RBA: Small Business Economic and Financial Conditions."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not decide applications. - business.gov.au: Apply for a business loan.\n- ABA: 2025 Banking Code of Practice.\n- ASIC: Unfair contract term protections.\n- AFCA: Appropriate lending to small business approach.\n- RBA: Small Business Economic and Financial Conditions. ---" },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
...
const c1_bank_vs_non_bank_business_lenders: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["RBA: Small Business Economic and Financial Conditions, October 2025.", "ABA: 2025 Banking Code of Practice.", "AFIA: Online Small Business Lenders Code.", "ASIC: Unfair contract term protections.", "business.gov.au: Apply for a business loan."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "Should I apply to multiple lenders at once?", answer: "Applying blindly can waste time and may create unnecessary enquiries. It is better to understand lender fit first. - RBA: Small Business Economic and Financial Conditions, October 2025.\n- ABA: 2025 Banking Code of Practice.\n- AFIA: Online Small Business Lenders Code.\n- ASIC: Unfair contract term protections.\n- business.gov.au: Apply for a business loan. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
  ],
  relatedLinks: [
...
const c1_prospa: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Where this lender may sit in the search", body: "Prospa may be relevant when the business owner is comparing Australian SME finance options and wants to understand whether this lender path deserves a closer look. It is often researched by owners looking at online business lending, working capital and speed-focused options. The right fit still depends on lender criteria, business performance, affordability, security, loan purpose and documentation.", bullets: ["Check the current eligibility rules directly with the lender", "Compare total cost, not only the advertised rate", "Ask whether guarantees, security or repayment authorities apply", "Confirm repayment frequency before submitting documents"] },
    ...
    { heading: "Comparison One view", body: "Do not apply because a lender is familiar, fast or visible in search. Apply because the funding need, document pack, repayment rhythm and lender criteria appear to match. If those points are unclear, check readiness first and compare the funding path before choosing a lender." },
...
const c1_moula: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Where this lender may sit in the search", body: "Moula may be relevant when the business owner is comparing Australian SME finance options and wants to understand whether this lender path deserves a closer look. It is often researched by owners comparing online business lending, bank-statement assessment and non-bank funding options. The right fit still depends on lender criteria, business performance, affordability, security, loan purpose and documentation.", bullets: ["Check the current eligibility rules directly with the lender", "Compare total cost, not only the advertised rate", "Ask whether guarantees, security or repayment authorities apply", "Confirm repayment frequency before submitting documents"] },
    { heading: "Documents and questions to prepare", body: "A stronger lender enquiry starts with evidence. Prepare the core facts before sending an application so the conversation is about fit, not missing information.", bullets: ["ABN and trading history", "Recent business bank statements", "Desired amount and use of funds", "Repayment source and timing window", "BAS, financials or tax position where relevant", "Invoices, contracts, purchase orders or asset quotes where relevant"] },
    { heading: "Comparison One view", body: "Do not apply because a lender is familiar, fast or visible in search. Apply because the funding need, document pack, repayment rhythm and lender criteria appear to match. If those points are unclear, check readiness first and compare the funding path before choosing a lender." },
...
const c1_ondeck: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Where this lender may sit in the search", body: "OnDeck may be relevant when the business owner is comparing Australian SME finance options and wants to understand whether this lender path deserves a closer look. It is often researched by owners comparing short-term working capital, online lending and non-bank assessment routes. The right fit still depends on lender criteria, business performance, affordability, security, loan purpose and documentation.", bullets: ["Check the current eligibility rules directly with the lender", "Compare total cost, not only the advertised rate", "Ask whether guarantees, security or repayment authorities apply", "Confirm repayment frequency before submitting documents"] },
    { heading: "Documents and questions to prepare", body: "A stronger lender enquiry starts with evidence. Prepare the core facts before sending an application so the conversation is about fit, not missing information.", bullets: ["ABN and trading history", "Recent business bank statements", "Desired amount and use of funds", "Repayment source and timing window", "BAS, financials or tax position where relevant", "Invoices, contracts, purchase orders or asset quotes where relevant"] },
    { heading: "Comparison One view", body: "Do not apply because a lender is familiar, fast or visible in search. Apply because the funding need, document pack, repayment rhythm and lender criteria appear to match. If those points are unclear, check readiness first and compare the funding path before choosing a lender." },
...
const c1_judo_bank: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Where this lender may sit in the search", body: "Judo Bank may be relevant when the business owner is comparing Australian SME finance options and wants to understand whether this lender path deserves a closer look. It is often researched by owners comparing SME-focused banking, relationship lending and more traditional bank-style assessment. The right fit still depends on lender criteria, business performance, affordability, security, loan purpose and documentation.", bullets: ["Check the current eligibility rules directly with the lender", "Compare total cost, not only the advertised rate", "Ask whether guarantees, security or repayment authorities apply", "Confirm repayment frequency before submitting documents"] },
    { heading: "Documents and questions to prepare", body: "A stronger lender enquiry starts with evidence. Prepare the core facts before sending an application so the conversation is about fit, not missing information.", bullets: ["ABN and trading history", "Recent business bank statements", "Desired amount and use of funds", "Repayment source and timing window", "BAS, financials or tax position where relevant", "Invoices, contracts, purchase orders or asset quotes where relevant"] },
    { heading: "Comparison One view", body: "Do not apply because a lender is familiar, fast or visible in search. Apply because the funding need, document pack, repayment rhythm and lender criteria appear to match. If those points are unclear, check readiness first and compare the funding path before choosing a lender." },
...
const c1_scotpac: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Where this lender may sit in the search", body: "ScotPac may be relevant when the business owner is comparing Australian SME finance options and wants to understand whether this lender path deserves a closer look. It is often researched by owners comparing invoice finance, debtor finance, working capital and specialist business finance. The right fit still depends on lender criteria, business performance, affordability, security, loan purpose and documentation.", bullets: ["Check the current eligibility rules directly with the lender", "Compare total cost, not only the advertised rate", "Ask whether guarantees, security or repayment authorities apply", "Confirm repayment frequency before submitting documents"] },
    { heading: "Documents and questions to prepare", body: "A stronger lender enquiry starts with evidence. Prepare the core facts before sending an application so the conversation is about fit, not missing information.", bullets: ["ABN and trading history", "Recent business bank statements", "Desired amount and use of funds", "Repayment source and timing window", "BAS, financials or tax position where relevant", "Invoices, contracts, purchase orders or asset quotes where relevant"] },
    { heading: "Comparison One view", body: "Do not apply because a lender is familiar, fast or visible in search. Apply because the funding need, document pack, repayment rhythm and lender criteria appear to match. If those points are unclear, check readiness first and compare the funding path before choosing a lender." },
...
const c1_zero_interest_loan_access_gap: C1PageData = {
  ...
  sections: [
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Economic Resilience Program.", "National Reconstruction Fund Corporation: Economic Resilience Program.", "Official participating bank pages, if linking to bank-specific program pages.", "Comparison One bank-decline page."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not guaranteed." },
  ],
  faqs: [
    ...
    { question: "What if my bank declines the program loan?", answer: "Ask why the application was declined before applying elsewhere. The reason will help determine whether another lender type may fit. - business.gov.au: Economic Resilience Program.\n- National Reconstruction Fund Corporation: Economic Resilience Program.\n- Official participating bank pages, if linking to bank-specific program pages.\n- Comparison One bank-decline page. ---" },
    { question: "Is Comparison One a lender?", answer: "No. Comparison One is not a lender and does not make credit decisions. It helps Australian business owners compare possible funding pathways and move toward a realistic next step." },
    { question: "Does Comparison One guarantee approval?", answer: "No. Approval, rates, terms, fees and timing depend on lender criteria and the business circumstances. The site provides General information only." },
  ],
  relatedLinks: [
...
const c1_vehicle_finance: C1PageData = {
  ...
  proofPoints: ["Written by Comparison One SME Finance Editorial Team", "General information only", "Comparison One is not a lender"],
  sections: [
    { heading: "What vehicle finance is", body: "Vehicle Finance is best treated as a funding-fit question, not a product label. The useful question is whether this pathway matches the asset, cash-flow timing, documentation, security position and repayment capacity of the business.\n\nFor Australian SMEs, vehicle finance may sit beside bank loans, non-bank loans, specialist facilities and preparation-only pathways. The right starting point depends on why the money is needed and what evidence can support the application." },
    ...
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Leasing or buying vehicles and equipment.", "business.gov.au: Choose your funding.", "business.gov.au: Apply for a business loan.", "business.gov.au: Key financial terms.", "ATO: Instant asset write-off for eligible businesses.", "ATO: $20,000 instant asset write-off for 2025–26."] },
...
const c1_tax_debt_funding: C1PageData = {
  ...
  proofPoints: ["Written by Comparison One SME Finance Editorial Team", "General information only", "Comparison One is not a lender"],
  sections: [
    { heading: "What ato and tax debt funding is", body: "ATO and Tax Debt Funding is best treated as a funding-fit question, not a product label. The useful question is whether this pathway matches the asset, cash-flow timing, documentation, security position and repayment capacity of the business.\n\nFor Australian SMEs, ato and tax debt funding may sit beside bank loans, non-bank loans, specialist facilities and preparation-only pathways. The right starting point depends on why the money is needed and what evidence can support the application." },
    ...
    { heading: "Comparison One fit-first checklist", body: "Before applying, ask these questions. The aim is not to make debt feel easy. The aim is to identify whether this funding path deserves a closer look.", bullets: ["What exact cash-flow gap or asset need are we solving?", "Is the need urgent, seasonal, asset-backed, invoice-backed or repeatable?", "Can the business service repayments without weakening the account?", "Would a bank, non-bank or specialist facility assess this more naturally?", "Is there a safer non-debt or advice-first pathway?", "What documents will make the application credible?", "What could make a lender say no?"] },
    { heading: "Source notes for editor", body: "---", bullets: ["ATO: Payment plans.", "ATO: Alternative payment plans.", "ATO: General interest charge rates.", "ATO: General interest charge.", "ATO: If you don't pay.", "ATO: Director penalty regime.", "business.gov.au: Apply for a business loan.", "business.gov.au: Choose your funding."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not promised." }
  ],
  faqs: [
...
const c1_line_of_credit: C1PageData = {
  ...
  proofPoints: ["Written by Comparison One SME Finance Editorial Team", "General information only", "Comparison One is not a lender"],
  sections: [
    { heading: "What business line of credit is", body: "Business Line of Credit is best treated as a funding-fit question, not a product label. The useful question is whether this pathway matches the asset, cash-flow timing, documentation, security position and repayment capacity of the business.\n\nFor Australian SMEs, business line of credit may sit beside bank loans, non-bank loans, specialist facilities and preparation-only pathways. The right starting point depends on why the money is needed and what evidence can support the application." },
...
const c1_trade_finance: C1PageData = {
  ...
  proofPoints: ["Written by Comparison One SME Finance Editorial Team", "General information only", "Comparison One is not a lender"],
  sections: [
    { heading: "What trade finance is", body: "Trade Finance is best treated as a funding-fit question, not a product label. The useful question is whether this pathway matches the asset, cash-flow timing, documentation, security position and repayment capacity of the business.\n\nFor Australian SMEs, trade finance may sit beside bank loans, non-bank loans, specialist facilities and preparation-only pathways. The right starting point depends on why the money is needed and what evidence can support the application." },
...
const c1_commercial_fitout: C1PageData = {
  ...
  proofPoints: ["Written by Comparison One SME Finance Editorial Team", "General information only", "Comparison One is not a lender"],
  sections: [
    { heading: "What commercial fitout funding is", body: "Commercial Fitout Funding is best treated as a funding-fit question, not a product label. The useful question is whether this pathway matches the asset, cash-flow timing, documentation, security position and repayment capacity of the business.\n\nFor Australian SMEs, commercial fitout funding may sit beside bank loans, non-bank loans, specialist facilities and preparation-only pathways. The right starting point depends on why the money is needed and what evidence can support the application." },
    ...
    { heading: "Comparison One fit-first checklist", body: "Before applying, ask these questions. The aim is not to make debt feel easy. The aim is to identify whether this funding path deserves a closer look.", bullets: ["What exact cash-flow gap or asset need are we solving?", "Is the need urgent, seasonal, asset-backed, invoice-backed or repeatable?", "Can the business service repayments without weakening the account?", "Would a bank, non-bank or specialist facility assess this more naturally?", "Is there a safer non-debt or advice-first pathway?", "What documents will make the application credible?", "What could make a lender say no?"] },
    { heading: "Source notes for editor", body: "---", bullets: ["business.gov.au: Apply for a business loan.", "business.gov.au: Choose your funding.", "business.gov.au: Leasing or buying vehicles and equipment.", "business.gov.au: Key financial terms.", "ATO: $20,000 instant asset write-off for 2025–26.", "ATO: Instant asset write-off for eligible businesses."] },
    { heading: "Editorial review and compliance", body: "Written by Comparison One SME Finance Editorial Team. Last reviewed 5 May 2026. Comparison One is not a lender. Comparison One is not a government agency. General information only. This page does not provide financial, credit, legal, tax or accounting advice. Funding options depend on lender criteria, business performance, affordability, credit history, security, industry, loan purpose and other factors. Approval is not promised." }
  ],
  faqs: [
